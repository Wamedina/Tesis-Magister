...
def Funcion_drawpoint(pos_x, pos_y, pos_z, col_height, DP_init, limites_x, limites_y, limites_z, TON, CP_S, CM_S, MIN, LEY, 
    ...
    for i in b1_l:
        ...
        b1 = int(i)
        b2 = int(b1 + 1)
        b3 = int(i + limites_y[3])
        b4 = int(b3 + 1)
        b5 = int(b3 + limites_y[3])
        b6 = int(b5 + 1)
