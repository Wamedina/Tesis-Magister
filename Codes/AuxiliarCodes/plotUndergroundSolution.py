...
def plotUndergroundModel(limites_x_C,limites_y_C,limites_z_C, drawpoints_blocks,drawpoints_xdt, drawpoints_ydt, periods): 
    ...
    for drawpoint in drawpoints_blocks:
        blocks = drawpoints_blocks[drawpoint]
            ...
            if drawpoints_xdt[(drawpoint, period)] == 1:
                ...
                for i in range(num_blocks):
                    if blocks:
                        ...
                        posicion = posicionar_bloque_CA(bloque, limites_x_C, limites_y_C, limites_z_C,[0,0,0])
